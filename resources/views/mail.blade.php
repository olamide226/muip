...
$mail = new PHPMailer(true);
        try {
            ...
            $mail->Body    = "Share Your refferal link with others: $email ref_link
            <br>They can also enter the code manually on the registration page.
            You can login <b><a href='redirection/fpl/web/login.php'>HERE</a></b> ";
